...
# Bot information
SESSION = environ.get('SESSION', 'Nisahnt_0786')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002413306770').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002489123101') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002483859543')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002489123101')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nishantyadav03747:9oHtORWVMlbqqqU4@cluster0.drkho.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Nisahnt_0786) # owner username without @
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Ni_Backup_2')
TUTORIAL = environ.get('TUTORIAL', '')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Ni_Backup_2') # Support Chat Link Without https:// or @
